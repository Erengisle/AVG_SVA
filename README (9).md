...
> **Obs:** adresserna är känsliga för stora och små bokstäver. Det ska stå `AVG_SVA`, inte `AVG_Sva`.
...
Övningsmeningarna är hämtade ur ett läromedel och används i undervisningen. Genomgångar, förklaringar och exempelmeningar på sidorna är egen text. Kontrollera att spridningen ryms inom skolans kopieringsavtal innan länkarna sprids utanför den egna undervisningsgruppen.
